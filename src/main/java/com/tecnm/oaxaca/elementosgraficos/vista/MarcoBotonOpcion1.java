...
public class MarcoBotonOpcion1 extends JFrame 
{
   ...
   public MarcoBotonOpcion1()
   {
      ...
      ManejadorBotonOpcion maneja = new ManejadorBotonOpcion();
      simpleJRadioButton.addItemListener( maneja );
      negritaJRadioButton.addItemListener(maneja);
      cursivaJRadioButton.addItemListener(maneja);
      negritaCursivaJRadioButton.addItemListener(maneja);
      setVisible(true);
   ...
   private class ManejadorBotonOpcion implements ItemListener 
   {
      ...
      {
          JRadioButton jrb =  (JRadioButton) evento.getSource();
         if(jrb == simpleJRadioButton){ 
         tipoLetra = ( tipoLetraSimple );
        } else if(jrb == negritaJRadioButton){ 
          tipoLetra = ( tipoLetraNegrita );
        } else if(jrb ==  cursivaJRadioButton){ 
          tipoLetra = ( tipoLetraCursiva );
        } else if(jrb == negritaCursivaJRadioButton){ 
